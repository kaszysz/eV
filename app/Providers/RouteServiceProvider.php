...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Route::bind('component', function ($value){
            return Component::withTrashed()->where('id', $value)->firstOrFail();
        });

        Route::bind('city', function ($value){
            return City::withTrashed()->where('id', $value)->firstOrFail();
        });
        ...
        Route::bind('retailer-pricing', function ($value){
            return RetailerPricing::withTrashed()->where('id', $value)->firstOrFail();
        });
