<template>
  <div class="text-xs mt-5">
    ...
    >
      <div class="w-2/12 text-center">{{ retailerPricing.retailer_index }}</div>
      <div class="w-2/12 text-center">
        {{ retailerPricing.product.producer.name }}
      </div>
      <div class="w-2/12 text-center">{{ retailerPricing.product.name }}</div>
